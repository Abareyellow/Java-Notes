...
public class StoreItem {
    ...
    public StoreItem(StoreItemBuilder storeItemBuilder) {
        name = storeItemBuilder.name;
        price = storeItemBuilder.price;
        shortDescription = storeItemBuilder.shortDescription;
        longDescription = storeItemBuilder.longDescription;
        stockAvailable = storeItemBuilder.stockAvailable;
        packagingType = storeItemBuilder.packagingType;
